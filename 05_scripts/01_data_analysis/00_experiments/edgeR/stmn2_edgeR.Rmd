...
barplot(exp1_dge$samples$lib.size, main = "Library Sizes Before Normalization", ylab = "Library Size")

## Carry out normalization using TMM
exp1_dge <- calcNormFactors(exp1_dge, method = "TMM")

# View normalization factors
exp1_dge$samples

# Get normalized counts per million (CPM)
normalized_counts <- cpm(exp1_dge)

# Apply normalization and plot normalization factors
barplot(exp1_dge$samples$lib.size * exp1_dge$samples$norm.factors, main = "Library Sizes After Normalization", ylab = "Effective Library Size")
