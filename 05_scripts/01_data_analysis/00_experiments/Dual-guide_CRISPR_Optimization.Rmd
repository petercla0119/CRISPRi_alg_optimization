...
# Import STMN2 sgRNA screen data
sgrna_stmn2 <- read.delim("~/Desktop/Projects/dual_guide_optimization/01_sorting-based_screens/stmn2/analysis_method/mageck/initial_mageck_09122024/stmn2_unpaired/results/test/High_vs_Low.sgrna_summary.txt", sep = "\t", header = TRUE)
# Import STMN2 gene data
gene_stmn2 <- read.table("~/Desktop/Projects/dual_guide_optimization/01_sorting-based_screens/stmn2/analysis_method/mageck/initial_mageck_09122024/stmn2_unpaired/results/test/High_vs_Low.gene_summary.txt", sep = "\t", header = TRUE)
