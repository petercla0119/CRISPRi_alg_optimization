...
# STMN2 <- read.delim("/Users/Claire/Library/CloudStorage/Box-Box/MSTP Research Rotations/Summer_2024_Might_Ward_Lab/CRISPRi_screenfiles/CRISPRi_alg_optimization/data_processed/rra-High-Low-STMN2.gene_summary.txt")
STMN2 <- read.delim("/Users/Claire/Downloads/corrected_tbl.gene_summary.txt")
# rra.High.Low.STMN2.sgrna_summary <- read.delim("//Users/Claire/Library/CloudStorage/Box-Box/MSTP Research Rotations/Summer_2024_Might_Ward_Lab/CRISPRi_screenfiles/CRISPRi_alg_optimization/data_processed/rra-High-Low-STMN2.sgrna_summary.txt")
rra.High.Low.STMN2.sgrna_summary <- read.delim("/Users/Claire/Downloads/corrected_tbl.sgrna_summary.txt")
